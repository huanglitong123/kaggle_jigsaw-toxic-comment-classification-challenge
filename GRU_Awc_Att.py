...
file_path = "./weight/weights_base_GRU2_patience1_2_2.best.hdf5"
batch_size = 32
epochs = 10
...
early = EarlyStopping(monitor="val_loss", patience=1, mode="min")
...
submission.to_csv('./result/GRU2_patience1_submission2_2.csv', index=False)
